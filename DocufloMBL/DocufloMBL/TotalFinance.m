...
-(void) viewDidLoad
{
    ...
    label1.text =@" INVOICE                                RECEIVED                     4/22/2015                      WORKFLOW ";
    ...
    label2.text =@" PAYMENT VOUCHER            RECEIVED                      4/22/2015                       WORKFLOW ";
...
- (void) labelTap1
{
    ...
    [pdfURL setObject:@"http://192.168.0.103/mobiledoc/inv000001.pdf" forKey:@"URL"];
...
- (void) labelTap2
{
    ...
    NSUserDefaults *pdfURL = [NSUserDefaults standardUserDefaults];
    [pdfURL setObject:@"http://192.168.0.103/mobiledoc/inv000002.pdf" forKey:@"URL"];
...
- (void) labelTap3
{
    ...
    NSUserDefaults *pdfURL = [NSUserDefaults standardUserDefaults];
    [pdfURL setObject:@"http://192.168.0.103/mobiledoc/inv000003.pdf" forKey:@"URL"];
...
- (void) labelTap4
{
    ...
    NSUserDefaults *pdfURL = [NSUserDefaults standardUserDefaults];
    [pdfURL setObject:@"http://192.168.0.103/mobiledoc/inv000004.pdf" forKey:@"URL"];
...
- (void) labelTap5
{
    ...
    NSUserDefaults *pdfURL = [NSUserDefaults standardUserDefaults];
    [pdfURL setObject:@"http://192.168.0.103/mobiledoc/inv000005.pdf" forKey:@"URL"];
...
- (void) labelTap6
{
    ...
    NSUserDefaults *pdfURL = [NSUserDefaults standardUserDefaults];
    [pdfURL setObject:@"http://192.168.0.103/mobiledoc/inv000006.pdf" forKey:@"URL"];
...
- (void) labelTap7
{
    ...
    NSUserDefaults *pdfURL = [NSUserDefaults standardUserDefaults];
    [pdfURL setObject:@"http://192.168.0.103/mobiledoc/inv000007.pdf" forKey:@"URL"];
...
- (void) labelTap8
{
    ...
    NSUserDefaults *pdfURL = [NSUserDefaults standardUserDefaults];
    [pdfURL setObject:@"http://192.168.0.103/mobiledoc/inv000008.pdf" forKey:@"URL"];
